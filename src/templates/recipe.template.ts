export function renderRecipeViewTemplate(): string {
  return `
    <section class="recipe-view ">
      ...
      <div class="container mb-3" id="favorite-button-container"></div>
      </div>
      ...
      <div class="container px-4 border-bottom pb-3 mb-3">
        <h2 id="recipe-title" class="mb-3"></h2>
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
          <div class="d-flex flex-wrap gap-2 align-items-center">
            <p id="preparation-time" class="mb-0 d-flex align-items-center gap-1"></p>
            <p class="border-end pe-2 mb-0 d-none d-sm-block" style="height: 20px;"></p>
            <p id="recipe-category" class="mb-0"></p>
            <p class="border-end pe-2 mb-0 d-none d-sm-block" style="height: 20px;"></p>
            <div class="d-flex align-items-center">
              <select class="form-select form-select-sm me-2" id="servings"></select>
              <p class="mb-0">Portionen</p>
            </div>
          </div>
          <div class="d-flex align-items-center gap-2">
            <button class="btn btn-sm btn-outline-secondary" id="edit-recipe-btn">✏️ <span class="d-none d-sm-inline">Rezept bearbeiten</span></button>
            <i class="bi bi-trash" style="cursor:pointer; font-size: 24px" data-bs-toggle="modal" data-bs-target="#deleteRecipeModal"></i>
          </div>
        </div>
      </div>
